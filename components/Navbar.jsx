...
// useEffect(() => {
  //   if (
  //     router.asPath === '/ArrayDestruct' ||
  //     router.asPath === '/ReactSmooth' ||
  //     router.asPath === '/ReactWeather' ||
  //     router.asPath === '/ReactParallax'||
  //   ) {
  ...
  >
    ...
    >
      ...
      <div
        className={
          nav
            ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#afbae1] p-10 ease-in duration-500'
        ...
        <div className='py-4 flex flex-col'>
          ...
          <div className='pt-40'>
            ...
            <div className='flex items-center justify-between my-4 w-full sm:w-[80%]'>
              ...
              <a href = "mailto: samikshawankhade11@gmail.com">
                <div
                  onClick={() => setNav(!nav)}
